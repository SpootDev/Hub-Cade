...
class WinMain(WahCade):
    ...
    def __init__(self, config_opts):
        ...
        self.intro_movie = os.path.isfile(self.wahcade_ini.get('intro_movie_file'))
        ...
        self.musicenabled = self.wahcade_ini.getint('enable_music')
        ...
        #### start intro movie
        if gst_media_imported and self.intro_movie:
    ...
    def check_music_settings(self):
        ...
        self.gstMusic = None
        if gst_media_imported and self.musicenabled:
            try:
        ...
        if romext == '' or '*':
            ...
            for romname in roms:
                if self.lsGames[self.sclGames.get_selected()][GL_ROM_NAME] in romname:
                    ...
                    romext = re.search('.{3}$',romname).group(0)
                    return romext
